...
func NewAuthRpcClient(r *gredis.Redis, natsUrl string, timeout int64) (*AuthClientNrpc, error) {
	s := &AuthClientNrpc{}
...
func (s *AuthClientNrpc) AuthToken(ctx context.Context, tokenStr string) (*AuthTokenRes, error) {
...
func (s *AuthClientNrpc) RefreshToken(ctx context.Context, tokenStr string) (*RefreshTokenRes, error) {
...
func (s *AuthClientNrpc) TokenInfo(ctx context.Context, tokenStr string) (*TokenInfoRes, error) {
