...
// func (s *Analzyer) AnalzyLogNFT(contract string, log *types.Log, nftrule *entity.Contractrule) (*mpcmodel.EthTx, error) {
...
// func (s *Analzyer) AnalzyLogFT(contract string, log *types.Log, ftrule *entity.Contractrule) (*mpcmodel.EthTx, error) {
// 	contract = strings.ToLower(contract)
// 	///
// 	if abicontract, ok := s.abiStructs[contract]; !ok {
// 		return nil, nil
